...
echarts.use([LineChart, TitleComponent, TooltipComponent, LegendComponent, GridComponent, CanvasRenderer, UniversalTransition])
...
function setOption() {
  ...
  chart.value.setOption({
    ...
    yAxis: { type: 'value' },
    series: props.series.map(s => ({ type: 'line', name: s.name, data: s.data, smooth: true }))
  })
}
